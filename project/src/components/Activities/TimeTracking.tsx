      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="flex items-end space-x-4">
          ...
          <button
            ...
            className="text-black font-semibold disabled:bg-gray-400 disabled:cursor-not-allowed px-6 py-2 rounded-lg flex items-center space-x-2 transition-colors hover:opacity-90"
            style={{ backgroundColor: !!activeEntry || !selectedActivityId ? undefined : '#D6FF27' }}
          >
